            ...
            <script type="text/javascript">
                $(document).ready(function (e) {
                    $("#uploadForm").on('submit', (function (e) {
                        e.preventDefault();
						$('.btnSubmit').addClass('fa fa-spinner');
                        $.ajax({
                            url: "upload.php"
                            , type: "POST"
                            ...
                            , success: function (data) {
								...
								$('.btnSubmit').removeClass('fa fa-spinner');
                            }
                            , error: function () {}
                        });
                    }));
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <br>
                                    <textarea name="desc" rows="5" class="form-control" maxlength="140" placeholder="Description....."></textarea>
                                    <br>
