...
<form action="edit" method="POST">
    ...
    <input type="text" name="title" class="form-control" value="<?php echo $title; ?>" placeholder="Title" autofocus><br>
    <input type="date" name="date" class="form-control" value="<?php echo $date; ?>" placeholder="Date"><br>
    <input type="text" name="venue" class="form-control" value="<?php echo $venue; ?>" placeholder="Venue"><br>
