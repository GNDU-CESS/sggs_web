            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <form action="edit_fac" method="POST">
                        ...
                        <input type="text" name="name" class="form-control" value="<?php echo $name; ?>" placeholder="Title" autofocus>
                        <br>
                        <input type="text" name="desig" class="form-control" value="<?php echo $desig; ?>" placeholder="Date">
                        <br>
                        <input type="email" name="email" class="form-control" value="<?php echo $email; ?>" placeholder="Venue">
                        <br>
