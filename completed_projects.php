                    ...
                    <section id="career" class="container">
                        <div class="row">
                            <div class="col col-sm-6">
                                ...
                                <p style="text-align:justify; font-family: 'Raleway-ExtraLight'">
                                    <div class="" style="padding:40px;background-color:#e0e0d1;">
                                        ...
                                        <p>Gurbani Sangeet has come to us in two forms i.e. written treatises and recordings/renderings in the shape of CDs. This project has been undertaken by Bhai Baldeep Singh, Visiting Professor in the Centre. It intends to review all these forms of Gurbani Sangeet with a view to assess the developments that have taken place since its inception</div>
                                    </p>
                            ...
                            <div class="col col-sm-4">
                                <br />
                                <br />
                                <br /> The projects under progress, the completed projects and the research publication are as follows:
                                <br />
                                <br />
                                <ul style="list-style:none;">
                                    <a href="research_publications.php">
                                        <li style="width:350px;height:40px;background-color:wheat;align:center;padding:2px">
                                            <h4>Research Publications</h4></li>
                                    </a>
                                    <br />
                                    <a href="underprogress.php">
                                        <li style="width:350px;height:40px;background-color:wheat;align:center;padding:2px">
                                            <h4>Projects under Progress</h4></li>
                                    </a>
                                    <br />
                                    <a href="completed_projects.php">
                                        <li style="width:350px;height:40px;background-color:wheat;align:center;padding:2px">
                                            <h4>Completed Projects</h4></li>
                                    </a>
                                    <br />
                                </ul>
                                <div style="background-color:#e0e0d1;padding:20px;text-align:center">
                                    ...
                                    <br />
                                    <br />
                                    <img src="img/books/mulya1.jpg" style="height:200px">
                                    <br />
                                    <br />
                                    <a href="img/books/japuji_sahib.pdf">
                                        <button type="button" class="btn btn-success">Download</button>
                                    </a>
                                    <br />
                                    <br />
                                    <br />
                                    <img src="img/books/hakikat.jpg" style="height:200px">
                                    <br />
                                    <br />
                                    <a href="img/books/japuji_sahib.pdf">
                                        <button type="button" class="btn btn-success">Download</button>
                                    ...
                                    <br />
                                    <br />
                                    <img src="img/books/japuji_sahib.jpg" style="height:200px">
                                    <br />
                                    <br />
                                    <a href="img/books/japuji_sahib.pdf">
                                        <button type="button" class="btn btn-success">Download</button>
                                    ...
                                    <br />
                                    <br />
                                    <img src="img/books/perspectives1.jpg" style="height:200px">
                                    <br />
                                    <br />
                                    <a href="img/books/japuji_sahib.pdf" <button type="button" class="btn btn-success">Download</button></a>
                                    <br />
                                    <br />
                                    <br />
                                </div>
