...
<?php include 'includes/nav.php';
    ...
    <div class="container fade1">
        ...
        <div class="row">
            ...
            <a  href="#here"><div class="col-md-3 col-sm-6 col-xs-12 fade0"><img class="size1 img-responsive fade0" src="img/director.jpg"><h3 class="name_style">Dr. Balwant Singh Dhillon</h3><h4 class="name_style">FOUNDER DIRECTOR</h4></div></a>
            <a href="#here" ><div  class="col-md-3 col-sm-3 col-xs-12 fade0" onclick="func1()"><img class="size1 img-responsive" src="img/faculty/prof kang 3.jpg"><h3 class="name_style">Dr Gulzar Singh Kang</h3><h4 class="name_style">OFFICATING DIRECTOR</h4></div></a>
            <a href="#here"><div class="col-md-3 fade0" onclick="func2()"><img class="size1 img-responsive" src="img/faculty/vedanti2.jpg"><h3 class="name_style">Singh Sahib Joginder Singh Vedanti</h3></div></a>
             <a href="#here"><div class="col-md-3 col-sm-3 col-xs-12 fade0" onclick="func3()"><img class="size1 img-responsive" src="img/faculty/n.jpg"><h3 class="name_style">Dr. N. Muthu Mohan</h3></div></a>
        ...
        <div class="row">
            ...
            <a href="#here"><div class="col-md-3 col-sm-6 col-xs-12 fade0" onclick="func4()"><img class="size1 img-responsive" src="img/faculty/amarjit.jpg"><h3 class="name_style">Dr. Amarjit Singh</h3></div></a>
            <a href="#here"><div class="col-md-3 col-sm-3 col-xs-12 fade0" onclick="func5()"><img class="size1 img-responsive" src="img/faculty/prof Amar Singh.jpg"><h3 class="name_style">Amar Singh</h3></div></a>
            <a href="#here"><div class="col-md-3 col-sm-6 col-xs-12  fade0" onclick="func6()"><img class="size1 img-responsive" src="img/faculty/Dr. jaswinder kaur Dhillon.jpg"><h3 class="name_style">Dr. Jaswinder Kaur Dhillon</h3></div></a>
            <a href="#here"><div class="col-md-3 col-sm-6 col-xs-12  fade0" onclick="func7()"><img class="size1 img-responsive" src="img/faculty/dharam_singh.jpg"><h3 class="name_style">Dr. Dharam Singh</h3> </div></a>
           
        </div>
        <div class="gap"></div>
        <div class="row">
            
             <a href="#here"><div class="col-md-3 col-sm-3 col-xs-12 fade0" onclick="func8()"><img class="size1 img-responsive" src="img/faculty/gurbir_singh.jpg"><h3 class="name_style">Gurbir Singh Brar</h3></div></a>
            <a href="#here"><div class="col-md-3 fade0" onclick="func9()"><img class="size1 img-responsive" src="img/faculty/sanghera.jpg"><h3 class="name_style">Dr. Gurnam Singh Sanghera</h3></div></a>
            <a href="#here"><div class="col-md-3 fade0" onclick="func10()"><img class="size1 img-responsive" src="img/faculty/gurcharan_singh_bal.jpg"><h3 class="name_style">Gurcharan Singh Bal</h3></div></a>
            <a href="#here"><div class="col-md-3 fade0" onclick="func11()"><img class="size1 img-responsive" src="img/faculty/Sukhpal singh.jpg"><h3 class="name_style">Sukhpal Singh </h3></div></a>
        </div>
        <div class="gap"></div>
        <div class="row">
...
Dr. Ruby Vig </h3></div></a>
        ...
        <div class="gap"></div>
        <div class="row">
        <a  href="#here"><div class="col-md-3 fade0" onclick="func20()"><img class="size1 img-responsive" src="img/faculty/jatinder singh.jpg"><h3 class="name_style">Dr. Jatinder Singh</h3></div></a>
            <a href="#here" ><div class="col-md-3 fade0" onclick="func21()"><img class="size1 img-responsive" src="img/faculty/Rajwinder Singh.jpg"><h3 class="name_style">Rajwinder Singh </h3></div></a>
            <a  href="#here"href="#here"href="#here"href="#here"><div class="col-md-3 fade0" onclick="func22()"><img class="size1 img-responsive" src="img/faculty/sukhdeep singh.jpg"><h3 class="name_style">Sukhdeep Singh  </h3></div></a>
             <a href="#here"href="#here"href="#here" ><div class="col-md-3 fade0" onclick="func23()"><img class="size1 img-responsive" src="img/faculty/Harpal singh.jpg"><h3 class="name_style">Dr. Harpal Singh </h3></div></a>
        ...
        <div class="gap"></div>
        <div class="row">
              <a  href="#here"href="#here"><div class="col-md-3 fade0" onclick="func24()"><img class="size1 img-responsive" src="img/faculty/Charnjit singh.jpg"><h3 class="name_style">Charnjit Singh </h3></div></a>
           <a href="#here" ><div class="col-md-3 fade0" onclick="func25()"><img class="size1 img-responsive" src="img/faculty/Rupinder kaur.jpg"><h3 class="name_style">Dr. Rupinder Kaur </h3></div></a>
            <a  href="#here"href="#here"><div class="col-md-3 fade0" onclick="func26()"><img class="size1 img-responsive" src="img/faculty/Bikram Singh.jpg"><h3 class="name_style">Bikramjit Singh</h3></div></a>
           
            <a  href="#here"><div class="col-md-3 fade0" onclick="func27()"><img class="size1 img-responsive" src="img/faculty/Altaf Mohd.jpg"><h3 class="name_style">Mohd Altaf Bhat </h3></div></a>
    ...
    <div class="row container">
        ...
        <div class="col-md-4"><img class="size1 img-responsive " id="change1" src="img/director.jpg"><h2 class="name_style1" id="change2">Dr. Balwant Singh Dhillon</h2><h4 class="name_style" id="change3">FOUNDER DIRECTOR</h4><h4 class="name_style" id="change4">CONTACT: (0091)9855057624. </h4><h4 class="name_style" id="change5">E-MAIL: balwantdhillon@yahoo.com </h4>
        </div>
        <div class="col-md-8">
