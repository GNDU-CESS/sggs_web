                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="center gap">
                                    <h1 style="margin-top:20px; margin-bottom:30px;" class="head1 head">Field Work</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 240px; width: 720px; height: 480px; overflow: hidden;">
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Recording team in the centre before interviewing principal Shergil</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Research scholars interviewing principal Shergil in recording room at centre</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Shukhpal Singh trying to communicate with interviewee</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Centre's team visiting nangal for interview related to 1947</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Centre's team visiting malwa region of punjab for the documentation</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Visit of chak fateh singh by the team of centre</p>
                                </div>
                                <img data-u="thumb" src="img/gallery/thumbs_fieldworks/thumb10.jpg" />
                            </div>

                            <div data-p="150.00" style="display: none;">
                                <img data-u="image" src="img/gallery/images/fieldworks/img12.jpg" />
                                <div class="carousel-caption">
                                    <p class="boxed">Team of Centre visited munger(Bihar) for the documentation of relics</p>
                                </div>
                                <img data-u="thumb" src="img/gallery/thumbs_fieldworks/thumb12.jpg" />
                            </div>
                            <div data-p="150.00" style="display: none;">
                                <img data-u="image" src="img/gallery/images/fieldworks/img13.jpg" />
                                <div class="carousel-caption">
                                    <p class="boxed">A team of centre visiting kuthala (nabha)</p>
                                </div>
                                <img data-u="thumb" src="img/gallery/thumbs_fieldworks/thumb13.jpg" />
                            </div>
                            <div data-p="150.00" style="display: none;">
                                <img data-u="image" src="img/gallery/images/fieldworks/img14.jpg" />
                                <div class="carousel-caption">
                                    <p class="boxed">Visit of bihar by the team of centre for research tour</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Reasearch scholars interviewing a person related to 1947 partition</p>
                                </div>
