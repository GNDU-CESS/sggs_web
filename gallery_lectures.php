   ...
   <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 960px; height: 480px; overflow: hidden; visibility: hidden; background-color: #24262e;">
        ...
        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 240px; width: 720px; height: 480px; overflow: hidden;">
            <div data-p="150.00" style="display: none;">
                ...
                <div class="carousel-caption"><p class="boxed">Boby Singh Bansal honored by a momento by the president of SGPC and GIani Joginder Singh Vedanti (former jathedar of Akal Takhat Sahib)</p></div>
                <img data-u="thumb" src="img/gallery/thumbs_lectures/thumb1.jpg" />
            </div>
            <div data-p="150.00" style="display: none;">
                <img data-u="image" src="img/gallery/images/lectures/img2.jpg" />
                <div class="carousel-caption"><p class="boxed">President of SGPC, Dr. Balwant Singh Dhillon, Boby Bansal sitting in director office</p></div>
                <img data-u="thumb" src="img/gallery/thumbs_lectures/thumb2.jpg" />
            </div>
            <div data-p="150.00" style="display: none;">
                <img data-u="image" src="img/gallery/images/lectures/img3.jpg" />
                <div class="carousel-caption"><p class="boxed">President of SGPC  visited the centre on 24-2-2016.</p></div>
                <img data-u="thumb" src="img/gallery/thumbs_lectures/thumb3.jpg" />
            </div>
            <div data-p="150.00" style="display: none;">
                <img data-u="image" src="img/gallery/images/lectures/img4.jpg" />
                <div class="carousel-caption"><p class="boxed">A group photo in Centre on the ocasion of exhibition of the Relics of the Sikh Guru's on 24-02-2016</p></div>
                <img data-u="thumb" src="img/gallery/thumbs_lectures/thumb4.jpg" />
            </div>
            <div data-p="150.00" style="display: none;">
                <img data-u="image" src="img/gallery/images/lectures/img5.jpg" />
                <div class="carousel-caption"><p class="boxed">Avtar Singh Makkar,Bobby Singh attending special lecture in CSSGGS </p></div>
                <img data-u="thumb" src="img/gallery/thumbs_lectures/thumb5.jpg" />
            </div>
            <div data-p="150.00" style="display: none;">
                <img data-u="image" src="img/gallery/images/lectures/img6.jpg" />
                <div class="carousel-caption"><p class="boxed">Renouned personality of the Sikh world while attending the special lecture in CSSGGS</p></div>
