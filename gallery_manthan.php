                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="center gap">
                                    <h1 style="margin-top:20px; margin-bottom:30px;" class="head1 head">Manthan</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 240px; width: 720px; height: 480px; overflow: hidden;">
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Dr. Balwant Singh Dhillon presenting presidential remarks over the paper of ''Sikh Virasat di Sambh Sambhal'' in Manthan</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Giani Joginder Singh Vedanti presiding in Manthan Programme</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Dr. Jasbir Singh Maan (Canada) in presenting paper in Manthan</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Dr. Dhillon, Purewal, Jathedar Vedanti, Variam Singh in Manthan programe</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Dr. Dhillon, Purewal, Jathedar Vedanti, Dr. Kang, Dr. JK Dhillon, Variam Singh in Manthan programe</p>
                                </div>
                                <img data-u="thumb" src="img/gallery/thumbs_manthan/thumb8.jpg" />
                            </div>
                            <div data-p="150.00" style="display: none;">
                                <img data-u="image" src="img/gallery/images/manthan/img9.jpg" />
                                <div class="carousel-caption">
                                    <p class="boxed">Seminar during manthan programme</p>
                                </div>
                                <img data-u="thumb" src="img/gallery/thumbs_manthan/thumb9.jpg" />
                            </div>
                            <div data-p="150.00" style="display: none;">
                                <img data-u="image" src="img/gallery/images/manthan/img10.png" />
                                <div class="carousel-caption">
                                    <p class="boxed">Seminar during manthan programme</p>
                                </div>
                                <img data-u="thumb" src="img/gallery/thumbs_manthan/thumb10.png" />
                            </div>
                        </div>
                        <!-- Thumbnail Navigator -->
