                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="center gap">
                                    <h1 style="margin-top:20px; margin-bottom:30px;" class="head1 head">Workshop</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 240px; width: 720px; height: 480px; overflow: hidden;">
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">A group photo of the staff.</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">A group photo of teacher (Dr. Parmjit Singh Sidhu) and students (USA's teacher)</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">CSSGGS hosted a workshop with colaboration with fullbright fellowship heys.</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">A group photo in building of the centre</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Farewell party after the successful end of workshop</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">A group photo of the deligates of workshop and the staff of school (khadoor sahib)</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Jatinder singh a scholar of CSSGGS presenting punjabi folk songs in farewll</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed"></p>Charnjit Singh a scholar of the CSSGGS singing poetry in farewell party of the workshop</div>
                                <img data-u="thumb" src="img/gallery/thumbs_workshops/thumb8.jpg" />
                            </div>
                            <div data-p="150.00" style="display: none;">
                                <img data-u="image" src="img/gallery/workshops/img9.jpg" />
                                <div class="carousel-caption">
                                    <p class="boxed">Staff with a foreign dignitary during a workshop.</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed"></p>A group of foreign delegates during a workshop</div>
                                <img data-u="thumb" src="img/gallery/thumbs_workshops/thumb10.jpg" />
                            </div>
                            <div data-p="150.00" style="display: none;">
                                <img data-u="image" src="img/gallery/workshops/img11.jpg" />
                                <div class="carousel-caption">
                                    <p class="boxed">American deligates with President of SGPC while visit of Sri Darbar Sahib (Golden Temple)</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">A moment of pride for the two differetn cultures</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Dr. Johnson presenting a gift of honor to the Vice Chancelor of Guru Nanak Dev University</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Group photo of the American deligates and staff of SGGS</p>
                                </div>
                            ...
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">Simmi, Salinder Singh, Frank, Jerry Tanaka in workshop</p>
                                </div>
                                <img data-u="thumb" src="img/gallery/thumbs_workshops/thumb15.jpg" />
                            </div>
                            <div data-p="150.00" style="display: none;">
                                ...
                                <div class="carousel-caption">
                                    <p class="boxed">A Group photo of the staff of Centre on Studies in Sri Guru Granth Sahib and American teachers</p>
                                </div>
