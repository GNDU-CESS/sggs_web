...
<style>
   ...
   .fixed {
	...
	.that{
	display:inline-block; float:none; margin:0 0 10px 0;
	border-color:#D7D7D7;
	}
...
<div class="head  animated fadeInUp">
    <div class="land-1">
			<div class="row">
				...
				<div class="row">
					<div class="col-lg-9 col-md-6" style="padding:0px;margin:0px">
						
						<div class="panel-body" style="height:800px;padding-top:0px;margin-top:-10px;">
							<div class="list-group">
							  <a href="research_publications" class="list-group-item">
							  <div style="background-color:#ff9933;color:#FFFFFF;padding:10px;">
								<h4 class="list-group-item-heading" style="padding:10px;color:#FFFFFF">Introduction</h4>
								<p class="list-group-item-text" style="text-align:justify;">Centre on Studies in Sri Guru Granth Sahib, Guru Nanak Dev University, Amritsar established on 1st April 2011. It owes its origin to the public announcement of September 2004 made by the then Prime Minister of India, Dr. Manmohan Singh, that Govt. of India will establish a Centre in Guru Nanak Dev University, Amritsar for Studies on Sri Guru Granth Sahib. <br><br> The message of Sri Guru Granth Sahib is holistic in nature. It is of great significance and relevance for the modern age. The main objective of the establishment of this Centre is to disseminate this wisdom academically all over the world in its true and authentic form.  <br><br>
									</p>
								</div>
							  </a>
							  <a href="activities" class="list-group-item">
								<div style="float:left;padding:20px;">
									<img src="img/carousel1.jpg" class="img-responsive img-thumbnail" alt="Cinque Terre" width="150" height="200">
								</div>
								<div style="background-color:#F0E68C;padding:10px;"> <!-- #F0E68C -->
									<h4 class="list-group-item-heading">Objective</h4>
									<p class="list-group-item-text" style="text-align:justify;">In the context of Sri Guru Granth Sahib being a repository of Divine Word, interfaith dialogue, and also being relevant for an holistic approach to human life and civilization, the study of the origin of Bani, (holy verses), its preservation, various modes of transmission, different schools of exegesis and impact of Sri Guru Granth Sahib upon human beings in general and on its devotees in particular, the establishment of a  Centre on Studies in Sri Guru Granth Sahib is one of the most desirable academic endeavour.</p>
								</div>
							  </a>
					...
					<div class="col-lg-3 col-md-6">
						<div class="panel-heading" style="padding:5px;margin-top:-10px;">
							<h3 class="panel-title size_reset" >Calendar</h3>
						</div>
						<div class="panel-body eve" style="height:360px; overflow:hidden;padding:0px;margin:-15px;" >
							<div class="panel-body" style="height:360px;">
								<!-- calendar to be added here  -->
							</div>
						</div>
						<div class="panel-heading" style="padding:5px;margin:0px;background-color:#E15822!important;">
							<h3 class="panel-title size_reset" >Quick Links</h3>
						</div>
						<div class="panel-body eve" style="height:400px;overflow:hidden;padding:0px;margin:-15px;" >
							<div class="panel-body" style="height:400px;">
								<div class="list-group">
								  <a href="research_publications" class="list-group-item" style="background-color:#C0C0C0;">
									<h4 class="list-group-item-heading" style="color:white!important">Research Publications</h4>
									<p class="list-group-item-text">For the proper interpretation......</p>
								  </a>
								<a href="activities" class="list-group-item" style="background-color:#696969;color:white;">
									<h4 class="list-group-item-heading">Manthan</h4>
									<p class="list-group-item-text">A Research Forum .....</p>
								  </a>
									<a href="gallery_foundation" class="list-group-item" style="background-color:#C0C0C0;color:white;">
									<h4 class="list-group-item-heading">Gallery-Foundation</h4>
									<p class="list-group-item-text">2 November, 2012....</p>
								  </a>
								<a href="playlist" class="list-group-item" style="background-color:#696969;color:white;">
									<h4 class="list-group-item-heading">Important Videos</h4>
									<p class="list-group-item-text">Watch latest videos....</p>
								  </a>
