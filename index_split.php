                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item  active">
                                ...
                                <div class="carousel-caption">
                                    <h3 class="boxed">Centre on Studies in Sri Guru Granth Sahib</h3>
                            ...
                            <div class="item">
                                ...
                                <div class="carousel-caption">
                                    <h3 class="boxed">ਤੁਰੀਆ ਗੁਣੁ ਮਿਲਿ ਸਾਧ ਪਛਾਨੇ ||</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                ...
                                <div class="row scroll" style="margin:0;">
                                    <div class="col-md-12">
                                        <blockquote>
                                            <p>I. Gurumustuk Singh Khalsa, founder and CTO of the SikhNet.com website will be speaking
                                                <br />
                                            </p>

                                            Date : <i> 15th March, 2016 </i>
                                            <br /> Day : <i>Tuesday</i>
                                            <br /> Place : <i>Guru Granth Sahib Bhawan</i>
                                            <br />
                                    ...
                                    <div class="col-md-12">
                                        <blockquote>
                                            <p>II. Special Lecture by Bobby Singh Bansal has presented over Sikh legacy in Pakistan
                                                <br> </p>

                                            Date : <i>25 January, 2016</i>
                                            <br /> Day : <i>Thursday</i>
                                            <br /> Place : <i>At Guru Granth Sahib Bhawan</i>
                                            <br />
                        ...
                        <div class="row">
                            <div class="row-same-height">
                                <div class="col-left col-lg-6 col-lg-height col-middle">
                                    ...
                                    <center>
                                        <h1 style="font-family: raleway">Introduction</h1></center>

                                    <p style="text-align:justify; padding:3%; font-family: raleway">Centre on Studies in Sri Guru Granth Sahib, Guru Nanak Dev University, Amritsar established on 1st April 2011, has completed five years of its existence. It owes its origin to the public announcement of 1St September 2004 made by the then Prime Minister of India, Dr. Manmohan Singh, that Govt. of India will establish a Centre in Guru Nanak Dev University, Amritsar for Studies on Sri Guru Granth Sahib.
                                        <br>
                                        <br>
                                        <center>
                                            <a href="files/English.pdf">
                                                <button style="text-align:center" class="btn btn-primary">Download PDF</button>
                                            </a>
                                        </center>
                                    </p>
                        ...
                        <div class="row">
                            ...
                            <div class="row-same-height">
                                ...
                                <div class="col-left col-lg-6 col-lg-height col-middle no-padding">
                                    ...
                                    <center>
                                        <h1 style="font-family: raleway;">Objective</h1></center>
